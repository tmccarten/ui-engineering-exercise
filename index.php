...
<html lang="en-GB">
  <head>
    ...
    <title>UI Engineer Exercise</title>
    <meta name="description" content="Responsive Churchill advert built with HTML and Sass/CSS">
    ...
    <main>
      ...
      <div class="component">
        ...
        <div class="speech-bubble">
          <p class="speech-bubble__text">...Oh Yes!</p>
        </div>
